...
public class ProgressBarPage {
    ...
    public int getPercentProgressBar() {
        ...
        return Integer.parseInt(driver.findElement(PERCENT_PROGRESS_BAR)
                .getText().replace("%", "")
                .trim());
    }
    ...
    public void stopProgressBarValueAndRefreshPage() {
        ...
        new WebDriverWait(driver, Integer.parseInt(dataTests.getProperty("explicit.time.progress.bar")))
